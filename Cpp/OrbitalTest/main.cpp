...
int main()
{
  ...
  {
    SetModulationTargetPtr setModulationTargetCmd =
      SetModulationTarget::create("X300", "", (const char*)X300IpAddress, true, "MyOutputId");
  ...
  sim.call(SetGlobalPowerOffset::create(0.0));
