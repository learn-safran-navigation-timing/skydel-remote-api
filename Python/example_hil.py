...
try:
  ...
  fixedAttitude = Attitude(toRadian(45), toRadian(2), 0)
  ...
  position, velocity = trajectory.generateEcefWithDynamics(elapsedMs)
  sim.pushEcefNed(elapsedMs, position, fixedAttitude, velocity, angularVelocity)
